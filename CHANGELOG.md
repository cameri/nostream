...
- [#756](https://github.com/cameri/nostream/pull/756) [`570a7cc`](https://github.com/cameri/nostream/commit/570a7ccd0f1d2fd3e6d98d2dba1542d49db455bf) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - feat: add relay-load-aware adaptive PoW difficulty (NIP-13)
  ...
  `eventId.minLeadingZeroBits` value (the static `pubkey.minLeadingZeroBits` check is unaffected and
...
- [#753](https://github.com/cameri/nostream/pull/753) [`7c2875e`](https://github.com/cameri/nostream/commit/7c2875ed3350343b8bca14a219418a2871cda6fb) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(admin): add GET /admin/network-health endpoint

- [#764](https://github.com/cameri/nostream/pull/764) [`ff43cd3`](https://github.com/cameri/nostream/commit/ff43cd3c72a4db5b970d07232cbfb2ed6536b0c3) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(admin): add Network Health panel to observability dashboard
...
- [#770](https://github.com/cameri/nostream/pull/770) [`07524eb`](https://github.com/cameri/nostream/commit/07524eb3d0c72b961ba632a6c6b35285fc4d3c1d) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - feat: add WoT-weighted NIP-56 content reporting
...
- [#737](https://github.com/cameri/nostream/pull/737) [`9f36191`](https://github.com/cameri/nostream/commit/9f361915deaccbb6a5853db6a4f91986cb339216) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - feat(dvm): add NIP-89 handler recommendation/information kinds and verify passive accept-and-serve
...
- [#738](https://github.com/cameri/nostream/pull/738) [`a0853db`](https://github.com/cameri/nostream/commit/a0853db8b9b460339642a5a79e3f12c0c3d36366) Thanks [@Anshumancanrock](https://github.com/Anshumancanrock)! - feat(nip43): issue kind 28935 invite codes on request
...
- [#741](https://github.com/cameri/nostream/pull/741) [`afa8999`](https://github.com/cameri/nostream/commit/afa89993e34e54b0aee65c18918dfd52896c275a) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(nip66): publish kind 30166 and 10166 relay health events after probe runs
  ...
  Fixes [#696](https://github.com/cameri/nostream/issues/696)
...
- [#781](https://github.com/cameri/nostream/pull/781) [`8d29f15`](https://github.com/cameri/nostream/commit/8d29f15de9c4dfedd74803c054813999a9879e67) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(admin): operator notification backend with Postgres outbox

  Adds transactional outbox dispatch for operator alerts (HTTP, Discord, Slack, Telegram), delivery log, `admin.notifications` settings, event hooks for admission invoices and settings changes, and admin test/history endpoints. Closes [#759](https://github.com/cameri/nostream/issues/759).

- [#763](https://github.com/cameri/nostream/pull/763) [`358763a`](https://github.com/cameri/nostream/commit/358763a67b7907c62eb2991aad5731a055132f22) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(ops): add /readyz readiness probe for Postgres and Redis
...
- [#779](https://github.com/cameri/nostream/pull/779) [`f6ee3e3`](https://github.com/cameri/nostream/commit/f6ee3e344556fda031c3c4ab92a329ada24d32da) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - feat: wire the WoT graph into adaptive PoW difficulty
...
- [#745](https://github.com/cameri/nostream/pull/745) [`276fe16`](https://github.com/cameri/nostream/commit/276fe16ede3f2a472989591e35cc8f476abde413) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - feat: add a Web of Trust graph service that tracks NIP-02 follow distance from an operator-configured seed pubkey
...
- [#773](https://github.com/cameri/nostream/pull/773) [`5577070`](https://github.com/cameri/nostream/commit/5577070b43fb5fe1b9f3695976c0f98972c56875) Thanks [@Ferryx349](https://github.com/Ferryx349)! - feat(shutdown): drain WebSocket clients on SIGTERM
...
- [#750](https://github.com/cameri/nostream/pull/750) [`f5c8dc8`](https://github.com/cameri/nostream/commit/f5c8dc8734ab376683424c01ab51822d3179dbe5) Thanks [@Anshumancanrock](https://github.com/Anshumancanrock)! - deploy: run production migrations from the relay image
...
- [#743](https://github.com/cameri/nostream/pull/743) [`f36410a`](https://github.com/cameri/nostream/commit/f36410aadb349d689a0d2740efeeca7dfb30d139) Thanks [@Ferryx349](https://github.com/Ferryx349)! - ci: build and push container image to GHCR after CI passes on main
...
- [#775](https://github.com/cameri/nostream/pull/775) [`59b1e51`](https://github.com/cameri/nostream/commit/59b1e51dfeca8b12a8615df3387ee37041663f04) Thanks [@Anshumancanrock](https://github.com/Anshumancanrock)! - fix: return COUNT results for filters with generic tag queries (`#e`, `#p`, `#g`, `#h`), which projected `event_id` twice and failed with "error: unable to count events"
...
- [#751](https://github.com/cameri/nostream/pull/751) [`8509aea`](https://github.com/cameri/nostream/commit/8509aea04581b9f13a927cead38df2db3017f508) Thanks [@Ferryx349](https://github.com/Ferryx349)! - deploy: minimal server bootstrap with optional settings overrides
...
- [#744](https://github.com/cameri/nostream/pull/744) [`8fa72d6`](https://github.com/cameri/nostream/commit/8fa72d62b4fac19999b27d459b41f99adff36d24) Thanks [@Ferryx349](https://github.com/Ferryx349)! - deploy: add production Docker Compose stack for relay servers
...
- [#765](https://github.com/cameri/nostream/pull/765) [`3690bd8`](https://github.com/cameri/nostream/commit/3690bd88951f3d139b36d75f5596ab4c5e7fc1ff) Thanks [@Ferryx349](https://github.com/Ferryx349)! - ci: disable CodeQL workflow
...
- [#771](https://github.com/cameri/nostream/pull/771) [`b07f9c3`](https://github.com/cameri/nostream/commit/b07f9c30c6346d523ca65bb1a171f93d5363964d) Thanks [@chappie-daemon](https://github.com/chappie-daemon)! - fix: enforce `limits.client.subscription.maxFilterValues` on REQ and COUNT filters
...
- [#747](https://github.com/cameri/nostream/pull/747) [`14cca60`](https://github.com/cameri/nostream/commit/14cca60789271f7964fd3b455bf7e624990771fa) Thanks [@Ferryx349](https://github.com/Ferryx349)! - fix(ci): publish container image after CI passes on main
...
- [#746](https://github.com/cameri/nostream/pull/746) [`7297b96`](https://github.com/cameri/nostream/commit/7297b967015f4c9335e9a461260f1a3f62a5ec04) Thanks [@Anshumancanrock](https://github.com/Anshumancanrock)! - fix(payments): stop stale invoices from wedging payment polling
...
- [#786](https://github.com/cameri/nostream/pull/786) [`e87e1af`](https://github.com/cameri/nostream/commit/e87e1af2d81902d9c5b5751cda71be20d34b62d9) Thanks [@Priyanshubhartistm](https://github.com/Priyanshubhartistm)! - fix(nip56): skip targetless report rows, record every p/e target, batch report inserts in one transaction, and warm the WoT graph at boot instead of blocking the first report on a cold-start rebuild
