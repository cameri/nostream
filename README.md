...
Default settings can be found under `resources/default-settings.yaml`. Feel free to copy it to `~/.nostr/settings.yaml` if you would like to have a settings file before running the relay first.
