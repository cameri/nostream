...
import { getPrivacyRequestHandler } from '../../../../src/handlers/request-handlers/get-privacy-request-handler'

describe('getPrivacyRequestHandler', () => {
  ...
  it('loads the privacy.html template', () => {
    getTemplateStub.returns('')

    getPrivacyRequestHandler({} as any, res, next)

    expect(getTemplateStub).to.have.been.calledWith('./resources/privacy.html')
  })
